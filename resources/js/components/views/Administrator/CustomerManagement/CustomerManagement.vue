    ...
    data() {
        return {
            ...
            tableCustomerHeaders: [
                ...
                { text: "Miner Level", value: "" },
                { text: "Referral Email", value: "" },
                { text: "Referal UID", value: "" },
                { text: "Nickname", value: "" },
                { text: "Withdrawal and Transfer", value: "" },
                { text: "state", value: "" },
                { text: "Withdrawal and Transfer", value: "" },
                { text: "State", value: "" },
                { text: "Aggreed to contract Agreement", value: "" },
                { text: "Online Status", value: "" },
                { text: "Registered IP", value: "" },
                { text: "Last Login IP", value: "" },
                { text: "Current Login IP", value: "" },
                { text: "Registered Source", value: "" },
                { text: "Number of Logins", value: "" },
                { text: "Queue", value: "" },
    ...
    methods: {
        ...
        fetchCustomers() {
            ...
            axios
                ...
                .then(response => {
                    this.tableCustomers = response.data.data;
                })
                .catch(error => {
                    console.log(error);
                })
        ...
        updateCustomer() {
            axios
                .put("/api/v1/customers/" + this.editedCustomerInformation.id, {
                    ..._.omit(this.editedCustomerInformation, "user"),
                    ...this.editedCustomerInformation.user,
                    password_confirmation: this.editedCustomerInformation.user
                        .password
