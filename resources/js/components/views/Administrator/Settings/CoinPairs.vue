            ...
            <v-card>
                ...
                <v-card-text>
                    <v-row justify="center">
                        ...
                        <v-col cols="12" md="6">
                            <v-select
                                :error-messages="formCoinPairErrors.coin"
                                v-model="defaultCoinPairInformation.coin"
                                :items="itemCoins"
                                item-text="name"
                                item-value="id"
                                label="Select Coin"
                        ...
                        <v-col cols="12" md="6">
                            <v-text-field
                                type="number"
                                :error-messages="formCoinPairErrors.amountRule"
                                :rules="rules.amountRules"
                                v-model="defaultCoinPairInformation.amount"
                                label="Amount"
            ...
            <v-card>
                ...
                <v-card-text>            
                        <v-container>
                            <v-data-table
                                :loading="tableLoading"
                                loading-text="Fetching Coin Pairs Asset's list... Please wait"
...
export default {
    ...
    methods: {
        ...
        updateCoin() {
            axios
                .put("/api/v1/coinpairs/" + this.editedCoinInformation.id, {
                    ..._.omit(this.editedCoinInformation, "user"),
                    ...this.editedCoinInformation.user,
                    password_confirmation: this.editedCoinInformation.user
                        .password
